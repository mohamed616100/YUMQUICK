...
class BestSellerGrad extends StatelessWidget {
  const BestSellerGrad({super.key, required this.bestSellerProducts});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      children: [
                        Text(
                            bestSellerProducts.rating!.toString(),
                            style: GoogleFonts.leagueSpartan(
                ...
                SizedBox(height: 4.h),
                Text(
                  bestSellerProducts.description!,
                  style: GoogleFonts.leagueSpartan(
                    fontSize: 13.sp,
                    fontWeight: FontWeight.w400,
